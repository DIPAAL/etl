...
from etl.constants import T_MMSI_COL, T_IMO_COL, T_SHIP_NAME_COL, T_SHIP_CALLSIGN_COL, T_A_COL, T_B_COL, T_C_COL, \
    T_D_COL, T_LOCATION_SYSTEM_TYPE_COL, T_MOBILE_TYPE_COL, T_SHIP_TYPE_COL, T_POSITION_FIXING_DEVICE_COL
...
class ShipDimensionInserter (BulkInserter):
    ...
    def ensure(self, df: pd.DataFrame, conn) -> pd.DataFrame:
        ...
        insert_query = """
            ...
            location_system_type, mobile_type, ship_type, position_fixing_device)
            VALUES {}
        ...
        select_query = """
            SELECT
                ...
                location_system_type, mobile_type, ship_type, position_fixing_device
            FROM dim_ship
            WHERE (mmsi, imo, name, callsign, a, b, c, d, location_system_type, mobile_type, ship_type,
                    position_fixing_device) IN {}
            """
