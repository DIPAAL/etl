...
SELECT create_reference_table('spatial_division');
...
SELECT create_distributed_table('fact_cell_5000m', 'division_id', shard_count=>'1');
SELECT create_distributed_table('fact_cell_1000m', 'division_id', colocate_with=>'fact_cell_5000m');
SELECT create_distributed_table('fact_cell_200m', 'division_id', colocate_with=>'fact_cell_5000m');
SELECT create_distributed_table('fact_cell_50m', 'division_id', colocate_with=>'fact_cell_5000m');
SELECT create_distributed_table('dim_cell_5000m', 'division_id', colocate_with=>'fact_cell_5000m');
SELECT create_distributed_table('dim_cell_1000m', 'division_id', colocate_with=>'fact_cell_5000m');
SELECT create_distributed_table('dim_cell_200m', 'division_id', colocate_with=>'fact_cell_5000m');
SELECT create_distributed_table('dim_cell_50m', 'division_id', colocate_with=>'fact_cell_5000m');
SELECT create_distributed_table('fact_heatmap', 'division_id', colocate_with=>'fact_cell_5000m');
