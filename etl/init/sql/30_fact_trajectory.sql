CREATE TABLE fact_trajectory (
    ...
    PRIMARY KEY (ship_id, ship_junk_id, start_date_id, start_time_id, end_date_id, end_time_id, eta_date_id, eta_time_id, nav_status_id, trajectory_sub_id),
...
-- index over start date and time
CREATE INDEX fact_trajectory_start_date_time_idx ON fact_trajectory (start_date_id, start_time_id);
-- index over end date and time
CREATE INDEX fact_trajectory_end_date_time_idx ON fact_trajectory (end_date_id, end_time_id);