...
def main(argv):
    ...
    parser.add_argument(
        "--load",
        help="Perform loading of the dates",
        action="store_true")
    parser.add_argument(
        "--clean",
        help="Clean the given AIS data file",
        action="store_true")
    parser.add_argument(
        "--date",
        help="The date to load, in the format YYYY-MM-DD, for example 2022-12-31",
        type=str)
