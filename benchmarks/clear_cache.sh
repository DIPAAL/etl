...
ssh -o "StrictHostKeyChecking=no" ubuntu@s1.dipaal.dk 'sudo bash -c "sync; echo 3 > /proc/sys/vm/drop_caches"'
ssh -o "StrictHostKeyChecking=no" ubuntu@s2.dipaal.dk 'sudo bash -c "sync; echo 3 > /proc/sys/vm/drop_caches"'
ssh -o "StrictHostKeyChecking=no" ubuntu@s3.dipaal.dk 'sudo bash -c "sync; echo 3 > /proc/sys/vm/drop_caches"'
ssh -o "StrictHostKeyChecking=no" ubuntu@s4.dipaal.dk 'sudo bash -c "sync; echo 3 > /proc/sys/vm/drop_caches"'
ssh -o "StrictHostKeyChecking=no" ubuntu@s5.dipaal.dk 'sudo bash -c "sync; echo 3 > /proc/sys/vm/drop_caches"'
ssh -o "StrictHostKeyChecking=no" ubuntu@s6.dipaal.dk 'sudo bash -c "sync; echo 3 > /proc/sys/vm/drop_caches"'
