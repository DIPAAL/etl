    ...
    FROM reference, (
        SELECT ST_Union(q1.rast) AS rast FROM (
            ...
            FROM (
                ...
                AND timestamp_from_date_time_id(fch.date_id, fch.time_id) <= timestamp_from_date_time_id(20220630, 235959) -- end_timestamp
                AND timestamp_from_date_time_id(fch.date_id, fch.time_id) >= timestamp_from_date_time_id(20220601, 0) -- start_timestamp
                ...
                AND fch.date_id BETWEEN 20220601 AND 20220630
